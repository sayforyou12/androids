...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(int i = 0; i<100; i++){
            ...
            student.setName("Mundo");
            student.setPhonenumber("010"+"-"+"000"+"0"+i+"-000"+"0"+i);
            student.setNumber("컴퓨터 공학");
            data.add(student);
        }
    ...
    public void onClick(View v){
        switch (v.getId()){
            case R.id.btn1:
                ...
                TextView phonenumber = (TextView) findViewById(R.id.text2);
                TextView number = (TextView) findViewById(R.id.text3);

                ModelStudent addData = new ModelStudent();
                addData.setName(nametext.getText().toString());
                addData.setPhonenumber(phonenumber.getText().toString());
                addData.setNumber(number.getText().toString());

...
public class CBMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maincb);
        ...
        // 2.어댑터를 생성하고 데이터 설정
        adapter = new CBListAdapter(this, R.layout.activity_list_adaptercb, R.id.txt, blickClr);
        ...
        countText = (TextView) findViewById(R.id.countText);
        final long sec = 0;
        final int millisInFuture = 15090 ;
